			...
			<div class="main-content">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active" targeturl='${pageContext.request.contextPath}/user/index'>绑定手机号</li>
						</ul>
					</div>
				...
				<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								<form  id='_form' class="form-horizontal" role="form" method="post" action="${pageContext.request.contextPath}/dobinduser" >
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">手机号码</label>

										<div class="col-sm-9">
											<input type="tel" name='username' placeholder="手机号码 " class="col-xs-10 col-sm-5">
										</div>
									</div>
